...
2️⃣ **[A] 현재 고객층(예: 30–40대 남성, 직장인) 강화 전략 2개**  ('[A]'를 명시해서 항목 헤더 꼭 포함, )
3️⃣ **[B] 유사매장 기반 확장 타겟 전략 2개** (우리 매장과의 적합성 설명 포함/'[B]'를 명시해서 항목 헤더 꼭 포함)  
4️⃣ 각 아이디어 형식 (항목 이름은 아래 텍스트 그대로 사용):
